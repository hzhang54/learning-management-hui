...
const CourseEditor = () => {
    // grab router with useRouter
    const router = useRouter();
    // useParams to grab information about the course
    const params = useParams();
    // get course id from params
    const id = params.id as string;
    // useGetCourseQuery passing in id, and get data:course, isloading, refetch
    // get a specific id once we are on this pag enad get update the entire form
    ...
    // useForm from reacthook form, and zodResolver from @hookform
  // methods for chadcn form  
...
// anytime course or methods change, it resets values. It's standard for React hook form.
  useEffect(() => {
    if (course) {
      methods.reset({
