...
const ChapterModal = () => {
    // grab the redux toolkit dispatches
  ...
  // initialize our stage or reset to empty if doesn't exist
  useEffect(() => {
    if (chapter) {
      methods.reset({
        title: chapter.title,
  ...
  // using redux action reducer to close modal
  const onClose = () => {
  ...
  const onSubmit = (data: ChapterFormData) => {
    ...
    // redux action add chapter or new chapter (if doesn't exist) dispatched
